...
class DetailPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final loadedPdt = Provider.of<ExtraMed>(context).findById(productId);
    Widget image_corousel1 = new Container(
      height: 250.0,
      child: new Carousel(
        boxFit: BoxFit.cover,
        images: [
          Image.asset(loadedPdt.medi_image),
          Image.asset(loadedPdt.medi_image1),
        ],
        autoplay: false,
        dotSize: 5.0,
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        width: 450.0,
                        child: Text(loadedPdt.medi_name, style: TextStyle(fontSize: 26.0, fontWeight: FontWeight.bold,),
                      ...
                      Row(
                        children: <Widget>[
                          Container(
                            ...
                            width: 43.0, height: 30.0, color: Colors.blue,
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          Container(
                              ...
                              child: Text('\u{20B9}${loadedPdt.medi_price}', style: TextStyle(fontSize: 25.0, fontWeight: FontWeight.bold,),)),
                          Container(
                            ...
                            child: RaisedButton(
                                ...
                                child: Center(
                                  heightFactor: 0.5,
                                  child: Text("Buy This", textScaleFactor: 1.0,
                                ...
                                onPressed: () {
                                  ...
                                  cart.addItem(productId, loadedPdt.medi_image, loadedPdt.medi_name, loadedPdt.medi_price);
                                }
                            ),
                          ),
                        ],
