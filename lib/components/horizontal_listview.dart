...
import 'package:medstore/components/pdt_item.dart';
...
class ExtraMed with ChangeNotifier {
  List <Medicine> med_list = [
    Medicine(
      id: '17',
      medi_image: 'images/home/tet2.jpg',
      medi_name: 'Tetley Green Tea',
      medi_image1: 'images/home/tet1.jpg',
      medi_price: 400,
      old_price: '480',
      ratings: " 4.2 ",
      reviews: "125 Ratings & 52 Reviews",
      brand: "    Tata Consumer Products",
        marketer: "Nestle India Ltd, "
            "11/13, Botawala Building 1st Floor, Office Nos, 2 to 6, Horniman Circle, Fort, Mumbai, Maharashtra 400001",
        desc: "Tetley Green Tea is undoubtedly an excellent source of anti-oxidants."
            "All the goodness now comes with immunity power of added Vitamin C with new Tetley Green Tea Immune Range."
            "While anti-oxidants help cleanse your body from within, Vitamin C helps support your body’s immune system.",

    ),
    Medicine(
      id: '18',
      medi_image: 'images/home/lb2.jpg',
      medi_name: ' Lifebuoy Sanitizer',
      medi_image1: 'images/home/lb1.jpg',
      medi_price: 210,
      old_price: '250',
      ratings: " 4.9 ",
      reviews: "505 Ratings & 235 Reviews",
      brand: "    Unilever India",
      marketer: "4V55+W82, Parshiwada, Kajuwadi, Chakala, Andheri East, Mumbai, Maharashtra 400047.",
      desc: "Has over 60% alcohol content and gives you instant germ protection."
          "Kills 99.9% bacteria and germs without water. It has Glycerine, it leaves your skin feeling moisturised."
          "Also comes in a convenient easy to carry a pack that helps protect you when out of the home."
    ),
    Medicine(
      id: '19',
      medi_image: 'images/home/omr2.jpg',
      medi_name: 'BP Monitor',
      medi_image1: 'images/home/omr1.jpg',
      medi_price: 850,
      old_price: '999',
      ratings: " 4.5 ",
      reviews: "56 Ratings & 25 Reviews",
      brand: "  Omron Corporation",
      marketer: "no 501, The Qube, 5th Floor, Unit, 504, Sir Mathuradas Vasanji Rd, Marol, Andheri East, Mumbai, Maharashtra 400059",
      desc: "The Omron hem 7120 is a compact fully automatic blood pressure monitor operating on the oscillometric principle."
          "It measures your blood pressure and pulse rate with easy one touch operation"
          "Omron hem-7120 comes with 3 years warranty and lifetime support provided by omron."
    ),
    Medicine(
      id: '20',
      medi_image: 'images/home/cr1.jpg',
      medi_name: ' Crocin 650',
      medi_image1: 'images/home/cr2.jpg',
      medi_price: 32,
      old_price: '40',
      ratings: " 4.6 ",
      reviews: "4120 Ratings & 1311 Reviews",
      brand: "    GlaxoSmithKline Asia Private Limited (GSKAP)",
      marketer: "24-25 Floor One Horizon Center, Golf Course Rd, DLF Phase 5, Gurugram, Haryana 122002",
      desc: "Crocin 650 Advance Tablet is a pain-relieving medicine with Optizorb technology. It is used for "
          "relieving fever and pain including toothache, headache, migraine, muscle ache, period pain, etc."
          "rocin Tablet works by inhibiting the formation of certain chemicals (prostaglandins) in the body."
...
class Products with ChangeNotifier {
  List <Product> product_list = [
    ...
    Product(
        id: "3",
        med_image: 'images/cat1/fh1.jpg',
        med_image1: 'images/cat1/fh2.jpg',
        med_name: ' New follihair',
        med_price: 520,
        old_price: '600',
        ratings: " 4.3 ",
        reviews: "521 Ratings & 15 Reviews",
        brand: "    ABBOTT",
