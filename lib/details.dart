              ...
              child: GridTile(
                  child: Column(
                    ...
                    children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                    children: <Widget>[
                                      SizedBox(height: 8.0,),
                                      Text('  Company Address', style: TextStyle(fontSize: 20.0,
                      ...
                      Container(
                        margin: EdgeInsets.only(left: 22.0, top: 15.0),
                        width: 362.0,
                        height: 30.0,
                        child: Text('Other products to look for', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
                      ),
                      Container(
