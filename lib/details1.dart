...
class DetailPage1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final loadedPdt = Provider.of<Gadgets>(context).findById(productId);
    Widget image_corousel1 = new Container(
      height: 250.0,
      child: new Carousel(
        boxFit: BoxFit.cover,
        images: [
          Image.asset(loadedPdt.gadget_image),
          Image.asset(loadedPdt.gadget_image1),
          //Image.asset(widget.product_detail_image),
          //Image.asset(widget.product_detail_image),
        ],
        autoplay: false,
        dotSize: 5.0,
    ...
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: Text('Gadget Details', style: TextStyle(fontSize: 24.0),),
        actions: <Widget>[
          // new IconButton(
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        width: 450.0,
                        child: Text(loadedPdt.gadget_name, style: TextStyle(fontSize: 26.0, fontWeight: FontWeight.bold,),
                      ...
                      Row(
                        children: <Widget>[
                          Container(
                              ...
                              child: Text('\u{20B9}${loadedPdt.gadget_price}', style: TextStyle(fontSize: 25.0, fontWeight: FontWeight.bold,),)),
                          Container(
                            margin: EdgeInsets.only(left: 120.0, top: 25.0),
                            height: 45.0,
                            width: 150.0,
                            child: RaisedButton(
                                ...
                                onPressed: () {
                                  ...
                                  cart.addItem(productId, loadedPdt.gadget_image, loadedPdt.gadget_name, loadedPdt.gadget_price);
                                }
                            ),
                          ),
                        ],
